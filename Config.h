...
{
public:
    ConfigDemodulation(string CacPhase, string filt, string unwrapFilt, string unwrap){
        SetParam(CacPhase, filt, unwrapFilt, unwrap);
    }
    void SetParam(string CacPhase, string filt, string unwrapFilt, string unwrap)
    {
        m_CacPhase = CacPhase;
        m_Filt = filt;
        m_Unwrap = unwrap;
        m_UnwrapFilt = unwrapFilt;
    }
